...
from modules.Facevid.util import KPHourglass, make_coordinate_grid, AntiAliasInterpolation2d, ResBottleneck, kp2gaussian,\
                         ResBlock3d, ResBlock2d, SameBlock2d, UpBlock2d
...
class KPDetector(nn.Module):
    ...
    def __init__(self, block_expansion=32, feature_channel=32, num_kp=15, image_channel=3, max_features=1024, reshape_channel=16384, reshape_depth=16,
                 num_blocks=5, temperature=0.1, estimate_jacobian=False, scale_factor=1, single_jacobian_map=False):
...
class HEEstimator(nn.Module):
    ...
    def __init__(self, block_expansion=64, feature_channel=32, num_kp=15, image_channel=3, max_features=2048, num_bins=66, estimate_jacobian=True):
