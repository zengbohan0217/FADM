...
from modules.Facevid.util import ResBlock2d, SameBlock2d, UpBlock2d, DownBlock2d, ResBlock3d, SPADEResnetBlock
from modules.Facevid.dense_motion import DenseMotionNetwork
...
class OcclusionAwareGenerator(nn.Module):
    ...
    def __init__(self, image_channel=3, feature_channel=32, num_kp=15, block_expansion=64, max_features=512, num_down_blocks=2,
                 reshape_channel=32, reshape_depth=16,
                 num_resblocks=6, estimate_occlusion_map=True, dense_motion_params=None, estimate_jacobian=False):
        ...
        self.dense_motion_network = DenseMotionNetwork(num_kp=num_kp, feature_channel=feature_channel,
                                                       estimate_occlusion_map=estimate_occlusion_map, block_expansion=32, max_features=1024,
                                                       num_blocks=5, reshape_depth=16, compress=4)
...
class OcclusionAwareSPADEGenerator(nn.Module):
    ...
    def __init__(self, image_channel, feature_channel, num_kp, block_expansion, max_features, num_down_blocks,
                 reshape_channel, reshape_depth,
